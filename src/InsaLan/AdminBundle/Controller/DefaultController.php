...
class DefaultController extends Controller
{
     ...
     * @Template()
     */
    public function pizzaAction(Request $request, $id = null) {
    ...
    $form = $this->createFormBuilder()
        ...
        ->setAction($this->generateUrl('insalan_admin_default_pizza', ['showAll' => $showAll]))
        ->getForm();
    ...
    if($id) {
      ...
      public function addAction(Entity\Order $order) {
          ...
          return $this->redirect($this->generateUrl("insalan_admin_default_pizza_1", array("id" => $order->getId())));
      ...
      public function order_removeAction(Entity\UserOrder $uo) {
          ...
          return $this->redirect($this->generateUrl("insalan_admin_default_pizza_1", array("id" => $id)));
      }

      /**
       * @Route("/pizza/order/{id}/status/{status}")
       * @Method({"POST"})
       */
      ...
      private function getAddUserOrderForm(Entity\Order $o) {
          ...
          return $this->createFormBuilder()
                      ...
                      ->setAction($this->generateUrl('insalan_admin_default_add', array('id' => $o->getId())))
                      ->getForm();
      }
