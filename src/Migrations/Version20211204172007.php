 ...
 */
final class Version20211204172007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE intra_PaymentStorage');
        ...
        $this->addSql('ALTER TABLE intra_TournamentGroup CHANGE statsType statsType INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE intra_TournamentManager DROP FOREIGN KEY FK_94DDEA20BBABFC4A');
        ...
        $this->addSql('DROP INDEX uniq_94ddea20bbabfc4a ON intra_TournamentManager');
        ...
        $this->addSql('ALTER TABLE intra_TournamentManager ADD CONSTRAINT FK_94DDEA20BBABFC4A FOREIGN KEY (participant_id) REFERENCES intra_Participant (id)');
        ...
        $this->addSql('ALTER TABLE tournamentroyalmatch_participant DROP FOREIGN KEY FK_E36976DF9D1C3019');
        $this->addSql('ALTER TABLE tournamentroyalmatch_participant DROP FOREIGN KEY FK_E36976DFE0726F1B');
        $this->addSql('DROP INDEX idx_e36976dfe0726f1b ON tournamentroyalmatch_participant');
        $this->addSql('CREATE INDEX IDX_66A7255FD4260FC ON tournamentroyalmatch_participant (tournamentroyalmatch_id)');
        $this->addSql('DROP INDEX idx_e36976df9d1c3019 ON tournamentroyalmatch_participant');
        $this->addSql('CREATE INDEX IDX_66A7255F9D1C3019 ON tournamentroyalmatch_participant (participant_id)');
        $this->addSql('ALTER TABLE tournamentroyalmatch_participant ADD CONSTRAINT FK_E36976DF9D1C3019 FOREIGN KEY (participant_id) REFERENCES intra_Participant (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE tournamentroyalmatch_participant ADD CONSTRAINT FK_E36976DFE0726F1B FOREIGN KEY (tournamentroyalmatch_id) REFERENCES intra_TournamentMatch (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE intra_User DROP locked, DROP expired, DROP expires_at, DROP credentials_expired, DROP credentials_expire_at, CHANGE username username VARCHAR(180) NOT NULL, CHANGE username_canonical username_canonical VARCHAR(180) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE email_canonical email_canonical VARCHAR(180) NOT NULL, CHANGE salt salt VARCHAR(255) DEFAULT NULL, CHANGE confirmation_token confirmation_token VARCHAR(180) DEFAULT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7C3A611CC05FB297 ON intra_User (confirmation_token)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE intra_PaymentStorage (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, description VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, client_email VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, client_id VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, total_amount INT DEFAULT NULL, currency_code VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, currency_digits_after_decimal_point VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, details LONGTEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci` COMMENT \'(DC2Type:json_array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE intra_TournamentGroup CHANGE statsType statsType INT DEFAULT 0');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_94DDEA20BBABFC4A ON intra_TournamentManager (participant_id)');
        ...
        $this->addSql('CREATE INDEX IDX_E36976DFE0726F1B ON tournamentroyalmatch_participant (tournamentroyalmatch_id)');
        $this->addSql('DROP INDEX idx_66a7255f9d1c3019 ON tournamentroyalmatch_participant');
        $this->addSql('CREATE INDEX IDX_E36976DF9D1C3019 ON tournamentroyalmatch_participant (participant_id)');
