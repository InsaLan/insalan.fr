...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PizzaOrderRepository")
 */
class PizzaOrder
{
    ...
    public function getOrdersOrdered() {
        ...
        usort($userOrders, array('App\Entity\PizzaUserOrder','cmp'));
        return $userOrders;
    }
     ...
     * Add orders
     *
     * @param \App\Entity\PizzaUserOrder $orders
     * @return Order
     */
    public function addOrder(\App\Entity\PizzaUserOrder $orders)
    {
        $this->orders[] = $orders;
     ...
     * @param \App\Entity\PizzaUserOrder $orders
     */
    public function removeOrder(\App\Entity\PizzaUserOrder $orders)
    {
