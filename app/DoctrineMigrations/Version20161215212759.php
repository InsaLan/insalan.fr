 ...
 */
class Version20161215212759 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE intra_Tournament DROP loginType');
        $this->addSql('ALTER TABLE intra_User DROP steamId, DROP battleTag');
    }
}
